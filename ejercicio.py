...
# Sidebar para cargar el archivo y seleccionar sucursal
...
if archivo_csv is not None:
    ...
    for producto in productos:
        with st.container():
            ...
            with col_izq:
                st.metric('Precio Promedio', f"${precio_promedio:,.2f}", f"{variacion_precio_promedio_anual:.2f}%")
                st.metric('Margen Promedio', f"{margen_promedio:.2f}%", f"{variacion_margen_promedio_anual:.2f}%")
